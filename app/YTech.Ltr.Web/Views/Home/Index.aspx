    ...
    <p>
        ...
        <ol>
            <li>
                ...
                within YTech.Ltr.Web/NHibernate.config</span>
	        </li>
            <li>
                Optionally, modify the Fluent NHibernate preferences within YTech.Ltr.Data.NHibernateMaps.GetConventions()
            ...
            <li>
                Open YTech.Ltr.Tests.dll via NUnit and make sure all the tests are turning green.
	        </li>
            <li>
                ...
                YTech.Ltr.Web.Controllers.RouteRegistrar.RegisterRoutesTo() after the scaffolding generator has completed.)
	        </li>
        </ol>
    </p>
    <p>
