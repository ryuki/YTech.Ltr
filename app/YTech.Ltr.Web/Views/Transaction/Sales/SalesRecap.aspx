...
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#list").jqGrid({
                url: '<%= Url.Action("ListSalesRecap", "Sales") %>',
                datatype: 'json',
                mtype: 'GET',
                colNames: ['','Tanggal', 'Jumlah Transaksi'],
                colModel: [
                    ...
                    { name: 'SalesDate', index: 'SalesDate', width: 100, align: 'left', key: true, editrules: { required: true, edithidden: false }, hidedlg: true, hidden: false, editable: true },
                    { name: 'SalesDetCount', index: 'SalesDetCount', width: 200, align: 'left', editable: true, edittype: 'text', editrules: { required: true }, formoptions: { elmsuffix: ' *'} }
                    ],
